                        ...
                        "<>": "div", "class": "card h-100 bg-white mbr-text border border-1", "html": [
                            {
                                "<>": "div", "class": "card-body display-7", "html": [
                                    {
                                        "<>": "span",
                                        "style": "font-size: 20px; font-weight: 500; position: absolute;top: 0;left: 0;background: orange;display: inline-block;padding: 10px;border-radius: 0.25rem 0 0 0;color: white;",
                                        "class": function () {
                                            if (this.ranking == 0) {
                                                return "d-none";
                                            } else {
